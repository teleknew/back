 ...
 *
 * Generated from protobuf message <code>sl.SLExtendedEventDescriptorProto</code>
 */
class SLExtendedEventDescriptorProto extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .sl.SLExtendedEventDescriptorProto.ItemProto items = 6;</code>
     */
    private $items;
    /**
     ...
     *     @type \Sl\SLExtendedEventDescriptorProto\ItemProto[]|\Google\Protobuf\Internal\RepeatedField $items
    ...
    /**
     * Generated from protobuf field <code>repeated .sl.SLExtendedEventDescriptorProto.ItemProto items = 6;</code>
     * @param \Sl\SLExtendedEventDescriptorProto\ItemProto[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Sl\SLExtendedEventDescriptorProto\ItemProto::class);
        $this->items = $arr;
