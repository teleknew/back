...
/**
 * Generated from protobuf message <code>sl.SLStreamProto</code>
 */
class SLStreamProto extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $use = false;
    /**
     * Generated from protobuf field <code>.sl.SLStreamTypeProto type = 4;</code>
     */
    protected $type = 0;
    /**
     *for es stream
    ...
    {
        GPBUtil::checkEnum($var, \Sl\SLStreamTypeProto::class);
        $this->type = $var;
