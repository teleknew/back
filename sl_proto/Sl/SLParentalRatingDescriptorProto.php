 ...
 *
 * Generated from protobuf message <code>sl.SLParentalRatingDescriptorProto</code>
 */
class SLParentalRatingDescriptorProto extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .sl.SLParentalRatingDescriptorProto.RatingProto ratings = 3;</code>
     */
    private $ratings;
     ...
     *     @type \Sl\SLParentalRatingDescriptorProto\RatingProto[]|\Google\Protobuf\Internal\RepeatedField $ratings
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .sl.SLParentalRatingDescriptorProto.RatingProto ratings = 3;</code>
     * @param \Sl\SLParentalRatingDescriptorProto\RatingProto[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setRatings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Sl\SLParentalRatingDescriptorProto\RatingProto::class);
        $this->ratings = $arr;
