 ...
 *
 * Generated from protobuf message <code>sl.SLServiceListDescriptorProto</code>
 */
class SLServiceListDescriptorProto extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .sl.SLServiceListDescriptorProto.ServiceProto services = 3;</code>
     */
    private $services;
     ...
     *     @type \Sl\SLServiceListDescriptorProto\ServiceProto[]|\Google\Protobuf\Internal\RepeatedField $services
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .sl.SLServiceListDescriptorProto.ServiceProto services = 3;</code>
     * @param \Sl\SLServiceListDescriptorProto\ServiceProto[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setServices($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Sl\SLServiceListDescriptorProto\ServiceProto::class);
        $this->services = $arr;
